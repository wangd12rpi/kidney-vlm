    ...
    *,
    ...
    for row_idx, row in out.iterrows():
        ...
        for series_path in series_paths:
            ...
            if artifact is None:
                continue
            matched_embedding_refs.append(str(artifact.embedding_ref).strip())
            matched_png_dirs.append(_to_registry_relative_path(root_dir, artifact.png_dir))
            matched_slice_counts.append(int(artifact.slice_count))

        if matched_embedding_refs:
